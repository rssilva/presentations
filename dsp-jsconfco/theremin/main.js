...
var theremin = (function () {
    ...
    return {
        ...
        routeSounds: function () {
            ...
            nodes.scuzzVolume.gain.value = 0;
        ...
        bindEvents: function () {
            ...
            socket.on('data', function (data) {
                // console.log(data)
                // osc.frequency.value = data.distance * 10 + 100
                var x = data.distance * 5;
                ...
                if (previousDistance && previousTime) {
                    speed = (data.distance - previousDistance) / (time - previousTime)
                    if (speed > 3) {
                        // console.log(speed)
                    }
                }
